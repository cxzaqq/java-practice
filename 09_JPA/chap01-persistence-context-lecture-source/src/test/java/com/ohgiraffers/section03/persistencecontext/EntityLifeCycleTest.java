...
public class EntityLifeCycleTest {
    ...
    *   비영속, 영속, 준영속, 삭제 상태 */
    ...
    public void nonPersistenceTest() {
        ...
        Assertions.assertNotSame(foundMenu, newMenu); // 동등하지만 동일하지는 않다.
    }
    ...
    public void persistenceTest() {
        ...
        Assertions.assertSame(foundMenu1, foundMenu2);
    }

    @Test
    public void AddPersistenceObjectTest() {

        /* 설명. 이 예제에서는 @Id에 해당하는 속성에 값을 넣기 위해 @GeneratedValue를 주석 처리할 것 */
        ...
        menuToRegist.setMenuPrice(500000);
        ...
        Assertions.assertSame(menuToRegist, foundMenu);
    }

    @Test
    public void persistenceObjectAddOrUpdateTest() {
        EntityTransaction transaction = entityManager.getTransaction();
        transaction.begin();
    ...
    @Test
    public void 준영속성ClearCloseTest() {
        EntityTransaction transaction = entityManager.getTransaction();
        transaction.begin();
...
//        entityManager.clear(); // 영속성 컨텍스트의 모든 영속 상태의 엔티티를 준영속 상태로 변경
    ...
    public void mergeUpdateTest() {
        ...
        menuToDetach.setMenuPrice(12000);

        Menu refoundMenu = entityManager.find(Menu.class, 5);
        System.out.println("detachedMenu.hashCode() = " + menuToDetach.hashCode());
        System.out.println("refoundMenu.hashCode() = " + refoundMenu.hashCode());

        entityManager.merge(menuToDetach);

        Menu mergedMenu = entityManager.find(Menu.class, 5);
        System.out.println("mergedMenu = " + mergedMenu);
        System.out.println("mergedMenu.hashCode() = " + mergedMenu.hashCode());
        assertEquals(12000, mergedMenu.getMenuPrice());
