...
public class Application {
    public static void main(String[] args) {
        ...
        *   그 메모리에 인스턴스가 단 하나만 생성되어 공유되게 하는 것을 싱글톤 패턴이라 함
        *   (메모리 및 리소스 낭비 방지 목적)
        *
        *  설명.
        *   장점
        *   1. 첫 번째 이용 시에는 인스턴스를 생성해야 하므로 속도 차이가 나지 않지만
        *   두 번째 이후 이용 시에는 인스턴스 생성 시간 없이 바로 사용할 수 있다.
        ...
        *  */
        ...
        System.out.println("eager2 주소: " + System.identityHashCode(eager2));
//        System.out.println(eager1 == eager2);

        /* 설명. LazySingleton은 객체 사용 시 객체가 할당 */
...
//        Calendar cal = new Calendar(); // Calendar도 싱글톤이다!
    }
}
